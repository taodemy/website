...
describe("Blog Page", () => {
  ...
  it("should render blog title in success", () => {
    ...
    const blogBrandingBtn = screen.getByRole("button", { name: /branding/i });
    const blogDesignBtn = screen.getByRole("button", { name: /design/i });
    expect(blogTitle).toBeInTheDocument();
    expect(blogSubTitle).toBeInTheDocument();
    expect(blogVideoBtn).toBeInTheDocument();
    expect(blogBrandingBtn).toBeInTheDocument();
    expect(blogDesignBtn).toBeInTheDocument();
  });

  it("should render large group of blog gallery section in success", () => {
